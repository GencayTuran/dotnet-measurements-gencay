...
namespace Interview.API.Test.Mocks
{
    public class DataHandlerServiceMock
    {
        ...
        private Dictionary<string, MeasurementModel> _dictionary = new Dictionary<string, MeasurementModel>
        {
            {
                "someHashKey1",
                new MeasurementModel
        ...
        public List<MeasurementModel> GetData_WithDuplicateValues()
        {
            _data.Add(new MeasurementModel()
            {
                ResourceId = "75ca6be9-1040-4797-b62d-74a41cae7655",
                DeviceName = "device_3",
                DeviceGroup = "group_b",
        ...
        public Dictionary<string, MeasurementModel> GetDictionaryFromData()
        {
            return _dictionary;
        }
    }
